...
class Moteurs:
    ...
    def avancer(self, vitesse, moteur = None): #moteur = 'g': tourner gauche | 'd': tourner droite | None : avancer en ligne droite
        #moteur gauche
        if moteur == "g" or moteur == None:
            IN1 = 0
            IN2 = 1
            ENA = 2
            self.moteurGauche[ENA].value = vitesse
        ...
        if moteur == "d" or moteur == None:
            ...
            IN4 = 1
            ENB = 2
            self.moteurDroit[ENB].value = vitesse
    ...
    def diagonale_gauche(self, vitesse):
        ...
        IN2 = 1
        ENA = 2
        self.moteurGauche[ENA].value = vitesse / 2
        self.moteurGauche[ENA].on()
        self.moteurGauche[IN1].on()
        self.moteurGauche[IN2].off()
    ...
    def diagonale_droite(self, vitesse):
        ...
        IN4 = 1
        ENB = 2
        self.moteurDroit[ENB].value = vitesse / 2
        self.moteurDroit[ENB].on()
        self.moteurDroit[IN3].on()
        self.moteurDroit[IN4].off()
